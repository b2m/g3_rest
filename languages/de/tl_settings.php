...
/**
 * Description for setting field g3_rest_cache_time
 * @global array $GLOBALS['TL_LANG']['tl_settings']['g3_rest_cache_time_label']
 * @name $TL_LANG['tl_settings']['g3_rest_cache_time_label']
 */
$GLOBALS['TL_LANG']['tl_settings']['g3_rest_cache_time_label'] = array('Cache Time', 'Die Zeit in Stunden, die der von dem Contao Modul generierte HTML Code im Cache Ordner gespeichert werden soll. Dies geschieht unabhängig vom Contao eigenen Cache. Um dieses Feature zu deaktivieren einfach 0 eingeben.');
